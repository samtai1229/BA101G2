...
function queryMotorByMotorPK(str) {
	...
	xhttp.open("GET", "/BA101G2/backend/motor.do?action=query&motno="+str, true);
	xhttp.send(null);
}
...
function queryRentOrdByRentOrdPK(str) {
	...
	xhttp.open("GET", "/BA101G2/backend/rentOrd.do?action=query&rentno="+str, true);
	xhttp.send(null);
}
...
function queryRentOrdBySlocno(str) {
	...
	xhttp.open("GET", "/BA101G2/backend/rentOrd.do?action=get_for_lease_view&slocno="+str, true);
	xhttp.send(null);
}
...
function queryRentOrdByRlocno(str) {
	...
	xhttp.open("GET", "/BA101G2/backend/rentOrd.do?action=get_for_return_view&rlocno="+str, true);
	xhttp.send(null);
}
