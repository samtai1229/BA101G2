...
<!--     <td><h3>最新消息</h3><font color=red>( MVC )</font></td> -->
<!--   </tr> -->
<!-- </table> -->
...
<ul>
  <li><a href="listAllNews.jsp">查詢全部最新消息</a></li><br><br>
...
<ul>
  <li><a href="<%=request.getContextPath()%>/backend/news/addNews.jsp">新增最新消息</a></li>
</ul>
</div>
<!----------------------------------------------- 後端網頁的側邊欄  和權限控管的必要片段程式碼 -->
