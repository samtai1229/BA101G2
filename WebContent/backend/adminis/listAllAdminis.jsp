...
<!----------------------------------------------- 後端網頁的側邊欄  和權限控管的必要片段程式碼 -->
	...
	<table class="table table-hover table-condensed table-striped table-bordered" style="margin-left:1px;">
		...
		<tr><th colspan="8"><jsp:useBean id="adminisSvs" scope="page" class="com.adminis.model.AdminisService" />

			<FORM METHOD="post"  style="display:inline;"  ACTION="<%=request.getContextPath()%>/adminis/adminis.do">
				<b>查詢管理員資料:</b> <select size="1" name="admno">
			...
			</FORM><a href="<%=request.getContextPath()%>/backend/adminis/addAdminis.jsp">新增管理員</a></tr>
	</table>
