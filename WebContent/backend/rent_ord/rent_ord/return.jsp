...
<!-- 標籤面板：標籤區開始 --><div role="tabpanel">
					      <ul class="nav nav-tabs" role="tablist">
					          ...
					          <li role="presentation">
					              <a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">還車</a>
					          </li>
					          <li role="presentation">
					              <a href="#tab3" aria-controls="tab3" role="tab" data-toggle="tab">狀態</a>
					          </li>
<!-- 標籤面板：標籤區結束 -->	  </ul>
			...
			<!--form功能 ??  -->     		<legend>依??查詢</legend>
							  ...
							  <div role="tabpanel" class="tab-pane" id="tab3">
					          		<fieldset>
						          		...
						          		<blockquote>已過客戶還車時間，請據點人員主動與客戶連繫並採取應對措施。</blockquote>
						          		<input type="submit" value="等待還車" class="btn btn-warning btn-lg"/>
						          		<blockquote>客戶已自取車據點取車，請注意。</blockquote>
									</fieldset>
							  </div>
<!--標籤面板 內容區結束 -->      </div>
<!--標籤面板 結束 -->		   </div>
