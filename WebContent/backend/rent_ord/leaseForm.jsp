...
<!-- FORM -->
				...
				<div class="form-horizontal member">
					...
					<div class="form-group  arr1">
						...
						<div class="col-xs-12 col-sm-8 innerDiv">
							<input type="text" name="note" value="${roQueryVO.note}" 
							class="form-control" readonly>
						</div>
					</div>
				...
				<div class="form-horizontal motor">
						...
						<div class="form-group  arr1">
							...
							<div class="col-xs-12 col-sm-8 innerDiv">
								<input type="text" name="displacement" value="${mmQueryVO.displacement}" 
								class="form-control" readonly>
							</div>
						</div>
						...
						<div class="form-group  arr1">
							<label for="aa" class="col-xs-12 col-sm-4 control-label">
								...
								<div class="col-xs-12 col-sm-8 innerDiv">
									...
									value="${(action =='change_lease_form_to_return_form')?'NA':'fail'}" 
									class="form-control" readonly>
								</div>
						</div>							
					</div>
...
<jsp:useBean id="ecSvc" scope="page" class="com.emt_cate.model.EmtCateService"/>	
				...
				<div class="clear"></div>
					...
					<hr>
					<p class="text-center">
					    <input type="hidden" name="action" value="after_lease_form">
	    					<button type="submit" class="btn btn-success">
								<i class="glyphicon glyphicon-ok"></i>確定
							</button>
