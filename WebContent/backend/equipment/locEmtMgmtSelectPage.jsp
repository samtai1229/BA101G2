...
<title>據點裝備查詢 - LocEmtMgmtSelectPage.jsp</title>
	...
	<div class="col-xs-12 col-sm-2 leftBar">
		...
		<div class="btn-group-vertical"  style="display: block;">
			<a class="btn btn-default" href="#" role="button">據點車輛管理</a> <a
				...
				class="btn btn-default" href="${pageContext.request.contextPath}/backend/equipment/locEmtMgmtSelectPage.jsp" role="button" style="background-color: #ddd;">據點裝備管理</a> <a
			...
			<div class="searchBar">
				<FORM METHOD="post" style="display: inline;"
					...
					<div class="form-group" style="display: inline;">
						<div class="col-sm-3">
							<label class="control-label" for="locno">查詢所在據點裝備：</label>
						</div>
						<div class="col-sm-7">
							<select class="form-control" name="locno" style="display: inline;">
