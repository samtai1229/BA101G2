...
<ul>
  <li><a href='<%=request.getContextPath()%>/backend/member/listAllMember.jsp'>List</a> all Member. </li> <br><br>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/frontend/member/addMember.jsp'>Add</a> a new Member.</li>
</ul>
