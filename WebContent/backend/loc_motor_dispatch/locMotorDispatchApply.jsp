	...
	<div class="col-xs-12 col-sm-2 leftBar">
		...
		<div class="btn-group-vertical"  style="display: block;">
			<a class="btn btn-default" href="#" role="button">據點車輛管理</a> <a
				...
				class="btn btn-default" href="${pageContext.request.contextPath}/backend/loc_motor_dispatch/locMotorDispatchApply.jsp" role="button" style="background-color: #ddd;">車輛調度申請</a> <a
