...
<title>總部調度單管理- motorDispatchMgmgHq.jsp</title>
	...
	<div class="col-xs-12 col-sm-2 leftBar">
		...
		<div class="btn-group-vertical" style="display: block;">
			<a class="btn btn-default"
				...
				role="button"  style="background-color: #ddd;">車輛調度</a> <a class="btn btn-default" href="#"
	...
	<div class="col-xs-12 col-sm-10 rightHTML">
		...
		<div class="container">
			...
			<div class="searchBar">
				<table>
					<tr>
						...
						<td><FORM METHOD="post"
								ACTION="${pageContext.request.contextPath}/backend/loc_motor_dispatch/motorDispatchMgmtHq.jsp">
								<input type="submit" name="serchAllMotorDispatchs" value="調閱所有調度單"
									class="btn btn-default" role="button">
							</FORM></td>

						<td><input type="button" name="insert" id="addMotor"
							class="btn btn-default" role="button"
							onclick="location.href='${pageContext.request.contextPath}/backend/loc_motor_dispatch/addMdjsp';"
							value="新增調度單"></td>
			...
			<table
				...
				<c:forEach var="mdVO" items="${list}" begin="<%=pageIndex%>"
					end="<%=pageIndex+rowsPerPage-1%>">

					<tr ${(mdVO.mdno == param.mdno) ? 'style="background-color:#84d8d1;"':''}>
						<td>${mdVO.mdno}</td>
						<td><c:forEach var="locVO" items="${locSvc.all}">
								${(mdVO.locno==locVO.locno)?locVO.locname:""}
							</c:forEach></td>
