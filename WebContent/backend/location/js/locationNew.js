...
function queryLocationByLocationPK(str) {
	...
	xhttp.open("GET", "/BA101G2/backend/location/location.do?action=getOne_For_Display&locno="+str, true);
	xhttp.send(null);
}
...
//console.log(xhttp.statusText);
	xhttp.open("GET","/BA101G2/backend/location/location.do?action=getOne_For_Update&locno=" + str,true);
	xhttp.send(null);
}