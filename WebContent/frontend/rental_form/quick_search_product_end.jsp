		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					...
					<i class="glyphicon glyphicon-alert navtext"></i>最新消息</a></li>
					...
					<c:if test="${not empty memno}">
						<li><a class="page-scroll navtext" href="<%=request.getContextPath()%>/backend/member/member.do?action=getOne_For_Enter&memid=${memno}">歡迎，${memname}</a></li>
						<li><a class="page-scroll navtext" href="<%=request.getContextPath()%>/backend/member/member.do?action=logout" data-toggle="modal">
						<i class="glyphicon glyphicon-user navtext"></i>登出</a>
						</li>
					</c:if>
				</ul>
			</div>
