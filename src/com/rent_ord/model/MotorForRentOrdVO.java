...
public class MotorForRentOrdVO implements java.io.Serializable {
	...
	private String note;
	private Set<RentOrdVO> rentOrds = new HashSet<RentOrdVO>();

	public MotorForRentOrdVO() {

	}

	public Set<RentOrdVO> getRentOrds() {
		return rentOrds;
	}

	public void setRentOrds(Set<RentOrdVO> rentOrds) {
		this.rentOrds = rentOrds;
	}
